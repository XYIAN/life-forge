...
// Zodiac-based quotes (placeholder structure)
export const ZODIAC_QUOTES: Record<string, string[]> = {
  aries: ['Courage is your birthright.', 'Lead with your heart, Aries.'],
  taurus: ['Steadfast as the earth beneath your feet.', 'Patience brings abundance, Taurus.'],
  gemini: ['Curiosity is your superpower.', 'Speak your truth, Gemini.'],
  cancer: ['Your intuition is your guide.', 'Nurture your soul, Cancer.'],
  leo: ['Shine bright, Leo.', 'Your courage inspires others.'],
  virgo: ['Perfection is found in the details.', 'Serve with love, Virgo.'],
  libra: ['Balance brings harmony.', 'Seek beauty in all things, Libra.'],
  scorpio: ['Transformation is your gift.', 'Embrace your depth, Scorpio.'],
  sagittarius: ['Adventure awaits you.', 'Expand your horizons, Sagittarius.'],
  capricorn: ['Climb every mountain.', 'Discipline leads to greatness, Capricorn.'],
  aquarius: ['Innovate and inspire.', 'Be the change, Aquarius.'],
  pisces: ['Dreams are your reality.', 'Flow with the tides, Pisces.'],
};

// Day-of-year quotes (placeholder structure)
export const DAY_QUOTES: Record<number, string> = {
  1: 'A new year, a new beginning.',
  2: 'Every day is a fresh start.',
  // ... up to 366
  365: 'Endings are new beginnings.',
};
...
export const OPPOSITE_SIGNS: Record<string, string> = {
  aries: 'libra',
  taurus: 'scorpio',
  gemini: 'sagittarius',
  cancer: 'capricorn',
